...
from selfservice_methods import changemethod, plusquantity,minusquantity,productprice,add_to_cart, quantity_selection,time_selection, payment_mode
from selfservice_methods import share_payment,datepicker, login,loginhere,siteselection,checkout_as_guest,create_account,find_element_by_text
from selfservice_methods import promocode, delete_cart_item, invalidgiftcard, giftcard,verification, card_payment, add_ons,checkout, execute_click_by_text
...
class TestBookNowBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.get(data["url_webstore"])
...
class TestWebStoreBooking(TestBookNowBase):
    ...
    def test_02_guestlogin_with_promocode(self):
        try:
            By_name = self.driver.find_element_by_name
            By_ID = self.driver.find_element_by_id
            By_xpath= self.driver.find_element_by_xpath
            ...
            payment_mode(self.driver, data["payment_via"])
            allure.attach(self.driver.get_screenshot_as_png(), name = 'payment_by_card_screen', attachment_type = AttachmentType.PNG)
    ...
    def test_03_newaccount_with_invalid_giftcard_promocode(self):
        try:
            By_name = self.driver.find_element_by_name
            By_ID = self.driver.find_element_by_id
            By_xpath= self.driver.find_element_by_xpath
    ...
    def test_04_loginhere_giftvoucher(self):
        try:
            By_name = self.driver.find_element_by_name
            By_ID = self.driver.find_element_by_id
            By_xpath= self.driver.find_element_by_xpath
