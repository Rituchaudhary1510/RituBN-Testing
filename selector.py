...
class bookingpageselectors:
    ...
    date_xpath="/html/body/div[2]/div/div[5]/div/div/form/div[2]/div[1]/div/div[1]/div/lightning-input/lightning-datepicker/div/div/input"
    ...
    other_productgroup="/html/body/div[2]/div/div[7]/div/div/div[2]/div/ul/li[2]"

    search_btn="/html/body/div[2]/div/div[5]/div/div/form/div[2]/div[1]/div/button"
    quantity = '/html/body/div[2]/div/div[5]/div/div/form/div[2]/div[1]/div/div[2]/div/div/div/div/select' 
    axe_qty="/html/body/div[2]/div/div[5]/div/div/form/div[2]/div[1]/div/div[3]/div/div/div/div/select"
    ...
    birthday_product = "/html/body/div[2]/div/div[7]/div/div/div[2]/div/ul/li[4]"
    sub_product2 = "/html/body/div[2]/div/div[7]/div/div/span[2]/div[1]/div/div/div[1]/div"
    birhday_product2_xpath ="/html/body/div[2]/div/div[7]/div/div/span[2]/div[1]/div/div/div[2]/div"
    time_slot2 = "/html/body/div[2]/div/div[5]/div/div/form/div[2]/div[1]/div[9]/div"
    ...
    discount_save_button_xpath="/html/body/div[2]/div/span[1]/span/span[2]/span/div/ul/li[1]/div/div[2]/div/div[2]/div/div[2]/button"
    ...
    cart_product="/html/body/div[2]/div/span[1]/span/span[2]/span/div/ul/li/div/div[2]"
    productname_in_cart="/html/body/div[2]/div/span[1]/span/span[2]/span/div/ul/li[1]/div/div[1]/div/div[1]/span"
    cross_btn_cart="/html/body/div[2]/div/span[1]/span/span[2]/span/div/ul/li[2]/div/div[2]/div/div[1]/span[2]/svg"
    ...
    cart_item="/html/body/div[2]/div/span[1]/span/span[2]/span/div/ul/li[2]/div/div[2]/div/div[1]"
    crx_btn_id="1"
class paymentselectors:
    ...
    send_payment_link_xpath = '/html/body/div[2]/div/span[2]/div[1]/div/ul/li[4]'
...
class customersearchselectors:
    ...
    MEMBERSHIP_DETAIL_BTN="/html/body/div[2]/div/div[3]/div/div[3]/div[3]/ul/li/section/div[1]/div/button[1]"
    new_booking_btn="/html/body/div[2]/div/div[3]/div/div[3]/div[3]/ul/li/section/div[1]/div/button[2]"
    ...
    rem_name_on_card="j_id0:j_id1:j_id806:j_id819"
    rem_card_number="j_id0:j_id1:j_id806:j_id821"
    rem_expiry_date="j_id0:j_id1:j_id806:j_id823"
    rem_expiry_year="j_id0:j_id1:j_id806:j_id826"
    rem_cv2="j_id0:j_id1:j_id806:j_id837"
    rem_pay_btn="j_id0:j_id1:j_id806:j_id847"